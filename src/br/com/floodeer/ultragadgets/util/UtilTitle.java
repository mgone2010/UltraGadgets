...
public class UtilTitle {
	 ...
	 *            - subtitulo
	 */
	public UtilTitle(String title, String subtitle) {
		this.title = title;
	 ...
	 *            - titulo
	 */
	public UtilTitle(UtilTitle title) {
		// Copy title
	 ...
	 *            Fade out time
	 */
	public UtilTitle(String title, String subtitle, int fadeInTime, int stayTime, int fadeOutTime) {
		this.title = title;
		this.subtitle = subtitle;
